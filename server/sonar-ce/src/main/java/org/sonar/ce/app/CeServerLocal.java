 ...
 * </p>
 */
public class CeServerLocal implements Monitored {
  private static final Logger LOG = Loggers.get(CeServerLocal.class);
  ...
  @VisibleForTesting
  protected CeServerLocal(ComputeEngine computeEngine, MinimumViableSystem mvs) {
  ...
  public static void main(String[] args) {
    ...
    CeServerLocal server = new CeServerLocal(
