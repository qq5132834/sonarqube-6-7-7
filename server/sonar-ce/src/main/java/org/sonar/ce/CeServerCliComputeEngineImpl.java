...
public class CeServerCliComputeEngineImpl implements ComputeEngine, ComputeEngineStatus {
  private final Props props;
  private final ComputeEngineContainer computeEngineContainer;

  private Status status = Status.INIT;

  public CeServerCliComputeEngineImpl(Props props, ComputeEngineContainer computeEngineContainer) {
    this.props = props;
  ...
  public void startup() {
    ...
    try {
      ...
      this.computeEngineContainer.setProps(props);
      this.computeEngineContainer.start();
    } finally {
