...
public interface Fortran77ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Fortran77Parser#typename_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypename_(Fortran77Parser.Typename_Context ctx);
	/**
	 * Visit a parse tree produced by {@link Fortran77Parser#type_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitType_(Fortran77Parser.Type_Context ctx);
	/**
