...
public interface Fortran77ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Fortran77Parser#typename_}.
	 * @param ctx the parse tree
	 */
	void enterTypename_(Fortran77Parser.Typename_Context ctx);
	/**
	 * Exit a parse tree produced by {@link Fortran77Parser#typename_}.
	 * @param ctx the parse tree
	 */
	void exitTypename_(Fortran77Parser.Typename_Context ctx);
	/**
	 * Enter a parse tree produced by {@link Fortran77Parser#type_}.
	 * @param ctx the parse tree
	 */
	void enterType_(Fortran77Parser.Type_Context ctx);
	/**
	 * Exit a parse tree produced by {@link Fortran77Parser#type_}.
	 * @param ctx the parse tree
	 */
	void exitType_(Fortran77Parser.Type_Context ctx);
	/**
